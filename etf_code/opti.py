...
class Opti:
    ...
    def optimize(self, max_assets=10, borrow_years=1/12):
        ...
        for cur in Data.possible_currencies:
            borrow_rate_annual[cur] = .015

        borrow_rate_annual['AUD'] += .037
        borrow_rate_annual['GBP'] += .04065

        borrow_rate_annual['PBW'] = .0307
        borrow_rate_annual['^GSPTSE'] = .0051
        borrow_rate_annual['EWU'] = .012
        borrow_rate_annual['IYR'] = .0096
        borrow_rate_annual['IYZ'] = .0294
        borrow_rate_annual['VPL'] = .0079
        borrow_rate_annual['EFA'] = .0042
        # borrow_rate_annual['^HSI'] = .01
        borrow_rate_annual['PL=F'] = .0347
        borrow_rate_annual['EWY'] = .007
        borrow_rate_annual['EZA'] = .0151
        borrow_rate_annual['XLB'] = .0028
        # borrow_rate_annual['EWY'] = .0079
        # borrow_rate_annual['VWO'] = .0045
        # borrow_rate_annual['XLB'] = .003
